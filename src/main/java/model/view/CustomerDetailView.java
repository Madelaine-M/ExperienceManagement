...
public class CustomerDetailView {
    ...
    private RecoveryActionSummary latestRecoveryAction;
    ...
    public CustomerDetailView(int customerId, String customerFirstName, String customerLastName, String email,
                              ...
                              RecoveryActionSummary latestRecoveryAction) {
        ...
        this.latestRecoveryAction = latestRecoveryAction;
    }
    ...
    public RecoveryActionSummary getLatestRecoveryAction() {
        return latestRecoveryAction;
    }

    public void setLatestRecoveryAction(RecoveryActionSummary latestRecoveryAction) {
        this.latestRecoveryAction = latestRecoveryAction;
    }
}
